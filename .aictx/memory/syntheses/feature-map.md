...
- CLI command suggest: `aictx suggest --after-task --json` emits ranked advisory `recommended_actions` plus the legacy broad fields and `remember_template`; non-JSON output shows the top recommendation and compact candidate actions.
